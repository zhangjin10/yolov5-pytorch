...
class YOLO(object):
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            draw.rectangle(
                ...
                fill=self.colors[c])
            draw.text(
                text_origin, str(label, 'UTF-8'), fill=(0, 0, 0), font=font)
            del draw
    ...
    def detect_heatmap(self, image, heatmap_save_path):
        ...
        for sub_output in outputs:
            ...
            sub_output = np.transpose(
                np.reshape(sub_output, [b, 3, -1, h, w]), [0, 3, 4, 1, 2])[0]
        ...
        plt.margins(0, 0)
        plt.savefig(
            heatmap_save_path, dpi=200, bbox_inches='tight', pad_inches=-0.1)
