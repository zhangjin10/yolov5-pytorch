...
if __name__ == "__main__":
    ...
    if True:
        ...
        optimizer = {
            ...
            'sgd':
            optim.SGD(pg0, Init_lr_fit, momentum=momentum, nesterov=True)
        }[optimizer_type]
        ...
        #   获得学习率下降的公式
        # ---------------------------------------#
        lr_scheduler_func = get_lr_scheduler(lr_decay_type, Init_lr_fit,
                                             Min_lr_fit, UnFreeze_Epoch)
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            if epoch >= Freeze_Epoch and not UnFreeze_flag and Freeze_Train:
                ...
                lr_limit_min = 3e-4 if optimizer_type == 'adam' else 5e-4
                Init_lr_fit = min(
                    max(batch_size / nbs * Init_lr, lr_limit_min),
                    lr_limit_max)
                Min_lr_fit = min(
                    max(batch_size / nbs * Min_lr, lr_limit_min * 1e-2),
                    lr_limit_max * 1e-2)
            ...
            fit_one_epoch(model_train, model, ema, yolo_loss, loss_history,
                          ...
                          epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda,
